...
mod tests {
    ...
    fn test_load_known() {
        ...
        let decoded: MockConfig = serde_json::from_str(s).unwrap();
    ...
    fn test_spec_mainnet_data_json() {
        ...
        path.push("testdata/mainnet_spec_data.json");
    ...
    fn test_spec_holesky_json() {
        let a = env!("CARGO_MANIFEST_DIR");
        let mut path = PathBuf::from(a);
        path.push("testdata/holesky_spec.json");
    ...
    fn test_spec_sepolia_data_json() {
        let a = env!("CARGO_MANIFEST_DIR");
        let mut path = PathBuf::from(a);
        path.push("testdata/sepolia_spec_data.json");
    ...
    fn test_spec_helder_yml() {
        let a = env!("CARGO_MANIFEST_DIR");
        let mut path = PathBuf::from(a);
        path.push("testdata/helder_spec.yml");
