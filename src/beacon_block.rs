...
use crate::response::VersionedResponse;

use super::{
    blinded_block_body::BlindedBeaconBlockBody, blobs_bundle::BlobsBundle,
    execution_payload::ExecutionPayload, spec::DenebSpec,
};
...
mod tests {
    ...
    use crate::utils::test_utils::test_encode_decode;

    use super::{SignedBlindedBeaconBlock, SubmitBlindedBlockResponse};

    #[test]
    fn test_signed_blinded_block_holeksy() {
        let data = include_str!("../testdata/signed_blinded_block_holesky.json");
        test_encode_decode::<SignedBlindedBeaconBlock>(&data);
    }

    #[test]
    fn test_signed_blinded_block_response_holeksy() {
        let data = include_str!("../testdata/submit_block_response_holesky.json");
    ...
    fn test_signed_blinded_block_builder_api() {
        let data = r#"{
        "message": {
          "slot": "1",
          "proposer_index": "1",
